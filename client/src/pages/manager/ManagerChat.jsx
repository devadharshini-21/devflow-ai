...
import { Send, MessageSquare, Loader2, FolderKanban, Users } from "lucide-react";
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-[#FAFAFA]">
            {loadingMessages ? (
              ...
              <div className="flex h-full flex-col items-center justify-center text-center text-slate-400">
                ...
                <p className="text-[11px]">Post an update or instruction for the developers working on this project.</p>
              </div>
            ) : (
              messages.map((msg) => {
